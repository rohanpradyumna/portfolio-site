 ...
 * always contained on both axes — a wide-but-short window can never push vertical
 ...
 * transformPagePoint correction — that double-corrects and breaks drag tracking.)
 */
